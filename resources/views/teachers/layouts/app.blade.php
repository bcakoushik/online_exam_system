            ...
            <div class="h-100">
                <div class="sidebar-logo">
                 ...
                 <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="#" class="sidebar-link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fa-solid fa-book pe-2"></i>
                            Exams
                        </a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href="{{ route('exams.create') }}" class="dropdown-item">
                                    <i class="fa-solid fa-file-circle-plus pe-2"></i>
                                    Create Exam
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('exams.index') }}" class="dropdown-item">
                                    <i class="fa-solid fa-pen-ruler pe-2"></i>
                                    Manage Exams
                                </a>
                            </li>
                            <li>
